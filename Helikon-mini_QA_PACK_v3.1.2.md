...
- `Helikon-mini_Install_Package_v3.1.2.json`
- `Helikon-mini_SYSTEM_LAYER_v3.1.2_install.md`
- `Helikon-mini_OPERATING_LAYER_v3.1.2_install.md`
- `Helikon-mini_QA_PACK_v3.1.2.md`
- `Helikon-mini_README_v3.1.2.md`
- `Helikon-mini_CHANGELOG_v3.1.2.md`
- `Helikon-mini_SHIP_rev29.md`
...
3) Confirm `Helikon-mini_Install_Package_v3.1.2.json` is still labeled as the **primary install artifact** and **installation SSOT**.
...
Goal: the 3.1.2 metadata-truth closure must remain benefit-first without weakening memory as a core operating surface.

Checks:
1) Open `Helikon-mini_README_v3.1.2.md`.
...
## D) Basic-user smoke test (recommended)
...
## E) System Layer checks (must pass)
...
## F) Operating Layer checks (must pass)
1) Ask: `INSTALL`
...
## G) Projects boundary lock (must pass)
Checks:
1) Open `Helikon-mini_Install_Package_v3.1.2.json`, `Helikon-mini_README_v3.1.2.md`, and `Helikon-mini_SHIP_rev29.md`.
...
## H) JSON integrity and parity lock (must pass)
Checks:
1) Open `Helikon-mini_Install_Package_v3.1.2.json`.
2) Confirm `package_version` = `3.1.2`.
...
10) Confirm `metadata_contract.non_runtime_fields` are not treated anywhere in active mini docs as extra runtime layers or commands.

Pass condition: 0 hash mismatches, 0 count mismatches, exact markdown↔JSON parity passes for the System snippets, embedded script, and all 6 memories.

---

## I) Command-family regression lock (must pass)
Search the active 3.1.2 runtime/install/procedure surfaces only:
- `Helikon-mini_Install_Package_v3.1.2.json`
- `Helikon-mini_SYSTEM_LAYER_v3.1.2_install.md`
- `Helikon-mini_OPERATING_LAYER_v3.1.2_install.md`
- `Helikon-mini_README_v3.1.2.md`
...
Pass condition:
- **0 live hits** in the active 3.1.2 runtime/install/procedure surfaces.
- Historical mentions are allowed in `Helikon-mini_CHANGELOG_v3.1.2.md` and `Helikon-mini_SHIP_rev29.md` when explicitly labeled historical.

---

## J) MUST invariants (mini ledger)
