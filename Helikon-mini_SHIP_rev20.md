# Helikon-mini SHIP Manifest — rev20 (v3.0.6 draft candidate)

Date: 2026-04-02

This manifest is the SSOT for the Helikon-mini 3.0.6 draft candidate bundle.
...
- `Helikon-mini_Install_Package_v3.0.6.json` is the **primary install artifact** and **installation SSOT** for this candidate set.
- `Helikon-mini_SYSTEM_LAYER_v3.0.1_install.md` and `Helikon-mini_OPERATING_LAYER_v3.0.6_install.md` are synchronized human-readable projections / fallbacks.
...
## Shipped files (v3.0.6 draft candidate)
1. `Helikon-mini_Install_Package_v3.0.6.json`
2. `Helikon-mini_SYSTEM_LAYER_v3.0.1_install.md`
3. `Helikon-mini_OPERATING_LAYER_v3.0.6_install.md`
4. `Helikon-mini_QA_PACK_v3.0.6.md`
5. `Helikon-mini_README_v3.0.6.md`
6. `Helikon-mini_CHANGELOG_v3.0.6.md`
7. `Helikon-mini_SHIP_rev20.md`
...
- Legacy mini 2.3.7 files are superseded by this 3.0.6 candidate set.
