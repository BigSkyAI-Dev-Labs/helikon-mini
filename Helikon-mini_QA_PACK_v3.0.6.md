# Helikon-mini QA Pack v3.0.6

Purpose: Validate the Helikon-mini 3.0.6 SETUP-clarity + synchronized-surface closure candidate set, enforce separation, and prevent drift/regressions.
...
- `Helikon-mini_QA_PACK_v3.0.6.md`
- `Helikon-mini_README_v3.0.6.md`
- `Helikon-mini_CHANGELOG_v3.0.6.md`
- `Helikon-mini_SHIP_rev20.md`
...
1) Open `Helikon-mini_Install_Package_v3.0.6.json`.
...
3) Confirm the SETUP guidance explicitly tells a first-time user where to go and what to paste:
   - **Profile/name menu → Personalization**, or
   - **Profile/name menu → Settings → Personalization**
   - **Snippet 1** goes into **Custom instructions**
   - **Snippet 2** goes into **About you → More about you**
   - It says there are **two separate text boxes** inside Personalization.
4) Confirm the ops line references:
   - `SETUP`
   - `INSTALL`
   - `EXTRACT`
   - `REMEMBER`
...
Pass condition: snippet fits platform limits, SETUP guidance is explicit enough for a first-time user, and only the normalized 3.0 command family remains.
...
Search the active 3.0.6 runtime/install/procedure surfaces only:
- `Helikon-mini_Install_Package_v3.0.6.json`
- `Helikon-mini_SYSTEM_LAYER_v3.0.1_install.md`
- `Helikon-mini_OPERATING_LAYER_v3.0.6_install.md`
- `Helikon-mini_README_v3.0.6.md`
...
Pass condition:
- **0 live hits** in the active 3.0.6 runtime/install/procedure surfaces.
- Historical mentions are allowed in `Helikon-mini_CHANGELOG_v3.0.6.md` and `Helikon-mini_SHIP_rev20.md` when explicitly labeled historical.
