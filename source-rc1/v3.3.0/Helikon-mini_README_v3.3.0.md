...
**Status:** `v3.3.0 draft_candidate / RC1`  
**License:** MIT  
...
1. Read `Helikon-mini_SHIP_rev32.md` and verify all eight files.
...
The distribution contains exactly the eight files named in `Helikon-mini_SHIP_rev32.md`. Engineering validators are intentionally outside the shipped eight-file ZIP. Static QA can establish package integrity and projection parity; live host persistence remains provisional until separately tested.
