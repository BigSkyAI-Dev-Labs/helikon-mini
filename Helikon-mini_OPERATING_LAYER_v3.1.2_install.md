...
- For the Operating Layer installer surface, treat the unified JSON install package as the installation SSOT.
  - Primary install artifact: `Helikon-mini_Install_Package_v3.1.2.json`
  - Human-readable projection/fallback: `Helikon-mini_OPERATING_LAYER_v3.1.2_install.md`
...
# Mount Helikon Mini 3.0 AIOS Operating Layer v3.1.2 — install (Saved Memories pack)
